...
<body>
    ...
    <div class="container">
        <div class="row mt-5 text-center">
            <div class="col">
                <h1 class="judul">Sistem Pengaduan Lampu PJU</h1>
                <h2 class="sub-judul">Kota Pekalongan</h2>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-md-6 mb-5">
                ...
                <h3 class="sub-judul">Masyarakat Kota Pekalongan</h3>
                <h6 class="sub-judul">Sistem Pengaduan Lampu Penerangan Jalan Umum</h6>
    ...
    <div class="container">
        <div class="row justify-content-center mt-3">
            ...
            <p class="col-5 md-auto text-center sub-judul"> Kami adalah sistem untuk melayani semua keluhan Anda, Khususnya daerah Kecamatan Pekalongan dan sekitarnya. Dimulai dari kategori Infrastruktur, Keamanan, Kesehatan, Pendidikan dan Kesejahteraan. Tanpa dipungut biaya apapun, alias Gratis! </p>
